...
const Homepage = function Homepage(props) {
  ...
  const [vintage, blueLights, caya] = [
    {backgroundImage: `url(${homepageImages[4].src})`},
    {backgroundImage: `url(${homepageImages[5].src})`},
    {backgroundImage: `url(${homepageImages[6].src})`}
  ]



  return (
    <div style={blueLights} id="homepage" data-testid='homepage' className={styles.homepageDiv}>
